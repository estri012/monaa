				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						@enderror>Tanggal @error('tanggal')
							 {{ $message }}
						@enderror</label>
						<input type="date" class="form-control" id="inputTanggal" name="tanggal" placeholder="Pick Date">
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						@enderror>Akta Lahir @error('aktalahir')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputAktalahir" name="aktalahir">
					</div>
					<div class="form-group col-md-6">
						...
						@enderror>Akta Mati @error('aktamati')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputAktamati" name="aktamati">
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						@enderror>Biodata @error('biodata')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputBiodata" name="biodata">
					</div>
					<div class="form-group col-md-6">
						...
						@enderror>KK @error('kk')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputKk" name="kk">
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						@enderror>KIA @error('kia')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputKia" name="kia">
					</div>
					<div class="form-group col-md-6">
						...
						@enderror>Surpin @error('surpin')
							 {{ $message }}
						@enderror</label>
						<input type="text" class="form-control" id="inputSurpin" name="surpin">
					</div>
				</div>
		</div>
